...
module.exports = function (app) {
  ...
  const subnets = new Schema({
    ...
    'micronet-bridge-openflow-node-id': { type: String, required: true },
    ...
    'micronet-bridge-nodeid': { type:String, required: true  },
    'connected-devices': [{type:Schema.Types.ObjectId, ref:'connectedDevices'}],
